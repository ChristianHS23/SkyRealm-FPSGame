...
public class BatAttack : MonoBehaviour {
	...
	void Update () {
		...
		enemyDeathStatus = this.GetComponent<BatHealth> ().enemyDeathStatus;
	...
	void WalkingToPlayer()
	{
		...
		if (distanceToPlayer > 8 && enemyDeathStatus == false && agent.enabled == true) {
			flagToAttack = false;
			...
			myAnimator.SetBool ("Fly Forward", false);
		}
